...
dockerTestRunLatest:
	...
	-e DRONE_REPO=sinlov/drone-file-browser-plugin \
	-e DRONE_REPO_NAME=drone-file-browser-plugin \
	-e DRONE_REPO_NAMESPACE=sinlov \
	-e DRONE_REMOTE_URL=https://github.com/sinlov/drone-file-browser-plugin \
	-e DRONE_REPO_OWNER=sinlov \
	...
	-e DRONE_COMMIT_LINK=https://github.com/sinlov/drone-file-browser-plugin/commit/68e3d62dd69f06077a243a1db1460109377add64 \
	...
	-e DRONE_BUILD_LINK=https://drone.xxx.com/sinlov/drone-file-browser-plugin/1 \
