...
func action(c *cli.Context) error {
	...
	config := plugin.Config{
		...
		FileBrowserBaseConfig: plugin.FileBrowserBaseConfig{
			...
			FileBrowserWorkSpace:         c.String("config.file_browser.work_space"),
		},

		FileBrowserWorkMode: c.String("config.file_browser.work_mode"),

		FileBrowserSendModeConfig: plugin.FileBrowserSendModeConfig{
			FileBrowserRemoteRootPath:     c.String("config.file_browser.send.remote_root_path"),
			FileBrowserDistType:           c.String("config.file_browser.send.dist_type"),
			FileBrowserDistGraph:          c.String("config.file_browser.send.dist_graph"),
			FileBrowserTargetDistRootPath: c.String("config.file_browser.send.target_dist_root_path"),
			FileBrowserTargetFileRegular:  c.String("config.file_browser.send.target_file_regular"),

			FileBrowserShareLinkEnable:             c.Bool("config.file_browser.send.share_link_enable"),
			FileBrowserShareLinkUnit:               c.String("config.file_browser.send.share_link_unit"),
			FileBrowserShareLinkExpires:            c.Uint("config.file_browser.send.share_link_expires"),
			FileBrowserShareLinkAutoPasswordEnable: c.Bool("config.file_browser.send.share_link_auto_password_enable"),
			FileBrowserShareLinkPassword:           c.String("config.file_browser.send.share_link_password"),
		},
...
func pluginFlag() []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{
			Name:    "config.file_browser.username,file_browser.username",
			Usage:   "must set args, file_browser username",
			EnvVars: []string{"PLUGIN_FILE_BROWSER_USERNAME"},
		},
		&cli.StringFlag{
			Name:    "config.file_browser.user_password,file_browser.user_password",
			Usage:   "must set args, file_browser user password",
			EnvVars: []string{"PLUGIN_FILE_BROWSER_USER_PASSWORD"},
		},
		&cli.StringFlag{
			Name:    "config.file_browser.work_space,file_browser.work_space",
		...
		&cli.UintFlag{
			Name:    "config.file_browser.timeout_push_second,file_browser.timeout_push_second",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.work_mode,file_browser.work_mode",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.send.dist_type,file_browser.send.dist_type",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.send.dist_graph,file_browser.send.dist_graph",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.send.remote_root_path,file_browser.send.remote_root_path",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.send.target_dist_root_path,file_browser.send.target_dist_root_path",
			Usage:   "path of file_browser local work on root, can set \"\"",
			Value:   "",
			EnvVars: []string{"PLUGIN_FILE_BROWSER_TARGET_DIST_ROOT_PATH"},
		},
		&cli.StringFlag{
			Name:    "config.file_browser.send.target_file_regular,file_browser.send.target_file_regular",
		...
		&cli.BoolFlag{
			Name:    "config.file_browser.send.share_link_enable,file_browser.send.share_link_enable",
			Usage:   "share dist dir as link",
			Value:   true,
			EnvVars: []string{"PLUGIN_FILE_BROWSER_SHARE_LINK_ENABLE"},
		},
		&cli.StringFlag{
			Name:    "config.file_browser.send.share_link_unit,file_browser.send.share_link_unit",
		...
		&cli.UintFlag{
			Name:    "config.file_browser.send.share_link_expires,file_browser.send.share_link_expires",
			Usage:   "if set 0, will allow share_link exist forever，default: 0",
			Value:   0,
			EnvVars: []string{"PLUGIN_FILE_BROWSER_SHARE_LINK_EXPIRES"},
		},
		&cli.BoolFlag{
			Name:    "config.file_browser.send.share_link_auto_password_enable,file_browser_share.send.link_auto_password_enable",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.send.share_link_password,file_browser.send.share_link_password",
...
func pluginHideFlag() []cli.Flag {
	return []cli.Flag{
		...
		// plugin hidden start
		&cli.BoolFlag{
			Name:    "config.file_browser.download.enable,file_browser.download.enable",
		...
		&cli.StringFlag{
			Name:    "config.file_browser.download.remote_path,file_browser.download.remote_path",
			Usage:   "file_browser download mode use remote path",
			Hidden:  true,
			EnvVars: []string{"PLUGIN_FILE_BROWSER_DOWNLOAD_REMOTE_PATH"},
		},
		&cli.StringFlag{
			Name:    "config.file_browser.download.local_path,file_browser.download.local_path",
